...
const Test = () => {
    ...
    return (
        <Flex direction="column" h="100vh" justifyContent="center" alignItems="center" textAlign="center" bg="gray">
            <Box className="questionBox" h="20%" alignItems="center" fontSize="2rem" padding="1rem" color="white">
                {question && <Text>{question}</Text>}
            </Box>
            <Flex className="btnBox" alignItems="center">
                <Button className="btn1" onClick={handleAnswerA} borderRadius="15px" cursor="pointer" fontSize="30px" bgGradient="linear(to-r, #29323C, #485563, #2B5876, #4E4376)" boxShadow="0 4px 15px 0 rgba(45, 54, 65, 0.75)" color="white" w="auto" m="10px">
                    {answerA}
                </Button>
                <Button className="btn1" onClick={handleAnswerB} borderRadius="15px" cursor="pointer" fontSize="30px" bgGradient="linear(to-r, #29323C, #485563, #2B5876, #4E4376)" boxShadow="0 4px 15px 0 rgba(45, 54, 65, 0.75)" color="white" w="auto" m="10px">
                    {answerB}
                </Button>
            </Flex>
